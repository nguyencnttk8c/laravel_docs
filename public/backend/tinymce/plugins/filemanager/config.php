...
$base_url = "http://laravel_docs.local"; //url base of site if you want only relative url leave empty
$upload_dir = '/uploads/filemanager/'; // path from base_url to upload base dir
